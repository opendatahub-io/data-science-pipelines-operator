...
type Database struct {
	...
	*ExternalDB `json:"externalDB,omitempty"`
	...
	// the user can provide a string: {"tls":"true"}. The "skip-verify" and "preferred" modes are
	// supported for compatibility but do not provide reliable security. Use "true" and provide a
	// trusted CA through spec.apiServer.cABundle when the database certificate is not signed by a
	// system-trusted CA.
	//
