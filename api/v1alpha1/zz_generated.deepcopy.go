...
func (in *DSPASpec) DeepCopyInto(out *DSPASpec) {
	*out = *in
	...
	if in.DevTools != nil {
		in, out := &in.DevTools, &out.DevTools
		*out = new(DevTools)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DevTools) DeepCopyInto(out *DevTools) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DevTools.
func (in *DevTools) DeepCopy() *DevTools {
	if in == nil {
		return nil
	}
	out := new(DevTools)
